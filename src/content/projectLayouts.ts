...
export const projectLayoutOverrides: ProjectLayouts = {
  ...
  kartino: {
    desktop: {
      ...
      domain: { col: 1, row: 2, cols: 3, rows: 2 },
      status: { col: 3, row: 4, cols: 2, rows: 2 },
      'kartino-asset-2': { col: 9, row: 1, cols: 4, rows: 7 },
      'empty-0': { col: 8, row: 1, cols: 1, rows: 3 },
      'empty-1': { col: 1, row: 1, cols: 3, rows: 1 },
      'empty-2': { col: 1, row: 4, cols: 2, rows: 2 },
      'empty-3': { col: 8, row: 4, cols: 1, rows: 4 },
      'metric-Flashcard creation latency': { col: 5, row: 4, cols: 3, rows: 2 },
      'metric-Test suite': { col: 1, row: 6, cols: 3, rows: 2 },
      'metric-Rating flow latency': { col: 5, row: 6, cols: 3, rows: 2 },
      'empty-4': { col: 4, row: 6, cols: 1, rows: 2 },
      summary: { col: 2, row: 8, cols: 6, rows: 3 },
      'link-https://kartino.it': { col: 8, row: 8, cols: 3, rows: 2 },
      'empty-5': { col: 1, row: 8, cols: 1, rows: 3 },
      'empty-6': { col: 11, row: 8, cols: 2, rows: 3 },
      challenge: { col: 1, row: 11, cols: 4, rows: 2 },
      response: { col: 5, row: 11, cols: 4, rows: 2 },
      result: { col: 9, row: 11, cols: 4, rows: 2 },
      'kartino-asset-0': { col: 1, row: 13, cols: 4, rows: 3 },
      stack: { col: 5, row: 13, cols: 4, rows: 3 },
      glyph: { col: 9, row: 13, cols: 3, rows: 3 },
      'kartino-asset-4': { col: 1, row: 16, cols: 4, rows: 5 },
      'kartino-asset-6': { col: 5, row: 16, cols: 4, rows: 5 },
      'kartino-asset-3': { col: 9, row: 16, cols: 4, rows: 5 },
      'highlight-0': { col: 1, row: 21, cols: 4, rows: 2 },
      'highlight-1': { col: 5, row: 21, cols: 4, rows: 2 },
      'kartino-asset-1': { col: 9, row: 21, cols: 4, rows: 3 },
      'kartino-asset-5': { col: 1, row: 23, cols: 4, rows: 5 },
      'lesson-0': { col: 5, row: 23, cols: 4, rows: 2 },
    },
  },
  recore: {},
  'replication-toolbox': {},
