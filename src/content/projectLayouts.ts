...
export const projectLayoutOverrides: ProjectLayouts = {
  ...
  kartino: {
    desktop: {
      role: { col: 4, row: 1, cols: 4, rows: 3 },
      domain: { col: 1, row: 3, cols: 3, rows: 2 },
      status: { col: 3, row: 5, cols: 2, rows: 2 },
      'kartino-asset-2': { col: 9, row: 2, cols: 4, rows: 8 },
      'metric-Flashcard creation latency': { col: 5, row: 4, cols: 2, rows: 2 },
      'metric-Test suite': { col: 5, row: 17, cols: 3, rows: 2 },
      'metric-Rating flow latency': { col: 7, row: 11, cols: 2, rows: 2 },
      summary: { col: 2, row: 8, cols: 7, rows: 2 },
      'link-https://kartino.it': { col: 9, row: 12, cols: 3, rows: 2 },
      challenge: { col: 2, row: 19, cols: 4, rows: 2 },
      response: { col: 6, row: 15, cols: 4, rows: 2 },
      result: { col: 11, row: 16, cols: 2, rows: 2 },
      'kartino-asset-0': { col: 2, row: 11, cols: 5, rows: 3 },
      stack: { col: 1, row: 16, cols: 4, rows: 3 },
      glyph: { col: 9, row: 18, cols: 3, rows: 3 },
      'kartino-asset-4': { col: 1, row: 23, cols: 3, rows: 4 },
      'kartino-asset-6': { col: 10, row: 22, cols: 3, rows: 4 },
      'kartino-asset-3': { col: 2, row: 28, cols: 3, rows: 7 },
      'highlight-0': { col: 4, row: 22, cols: 2, rows: 2 },
      'highlight-1': { col: 11, row: 30, cols: 2, rows: 2 },
      'kartino-asset-1': { col: 5, row: 24, cols: 4, rows: 3 },
  ...
  recore: {
    desktop: {
      role: { col: 2, row: 4, cols: 4, rows: 3 },
      'metric-Localization': { col: 8, row: 4, cols: 2, rows: 2 },
      'recore-asset-0': { col: 3, row: 10, cols: 6, rows: 4 },
      status: { col: 10, row: 1, cols: 2, rows: 2 },
      domain: { col: 6, row: 6, cols: 3, rows: 3 },
      summary: { col: 3, row: 1, cols: 7, rows: 3 },
      challenge: { col: 1, row: 12, cols: 2, rows: 2 },
      response: { col: 9, row: 12, cols: 2, rows: 2 },
      result: { col: 2, row: 14, cols: 3, rows: 2 },
      stack: { col: 2, row: 18, cols: 3, rows: 3 },
      glyph: { col: 9, row: 7, cols: 3, rows: 3 },
      'metric-Ecosystem integration': { col: 3, row: 16, cols: 5, rows: 1 },
      'metric-Resource access': { col: 6, row: 18, cols: 2, rows: 1 },
      'metric-Consortium scale': { col: 9, row: 14, cols: 4, rows: 3 },
      'highlight-0': { col: 10, row: 18, cols: 2, rows: 2 },
      'highlight-1': { col: 7, row: 24, cols: 4, rows: 2 },
      'highlight-2': { col: 2, row: 25, cols: 2, rows: 2 },
      'highlight-3': { col: 11, row: 26, cols: 2, rows: 2 },
      'lesson-0': { col: 1, row: 29, cols: 2, rows: 2 },
      'link-https://resiliage-ecosystem.eu': { col: 10, row: 28, cols: 2, rows: 2 },
      'next-0': { col: 9, row: 30, cols: 2, rows: 2 },
      'recore-asset-1': { col: 2, row: 22, cols: 4, rows: 3 },
